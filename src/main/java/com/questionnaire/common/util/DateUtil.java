...
public class DateUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*System.out.println(stampToDate("1509465600000",DateUtil.DATE_PATTERN));*/
//        System.out.println(date2TimeStamp("1997-03-11",DateUtil.DATE_PATTERN));
        /*
         ...
         */
        System.out.println(dateFormat(new Date(),DateUtil.HOUR_PATTERN));
    }
