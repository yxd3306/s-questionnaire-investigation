...
INSERT INTO `t_questionnaire` VALUES (137, '1', 6, NULL, '2019-02-25 15:54:49', '2019-02-25 15:59:39', 2);
INSERT INTO `t_questionnaire` VALUES (138, 'java测试1', 6, NULL, '2019-02-25 17:51:56', '2019-02-25 17:53:04', 2);
...
CREATE TABLE `t_questionnaire_context`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 699 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
